...
public class FourthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AlertDialog.Builder bld=new AlertDialog.Builder(FourthActivity.this);
        bld.setTitle("Which is the first ?")
                .setItems(str,new DialogInterface.OnClickListener(){
                    @Override
                    public void onClick(DialogInterface dialog,int which){
                        Toast.makeText(FourthActivity.this,str[which]+" first",Toast.LENGTH_SHORT).show();
    ...
    View.OnClickListener iBLTR=new View.OnClickListener(){
        ...
        public void onClick(View v){
            ...
            if(over){
                Toast.makeText(FourthActivity.this,"Game Over!!!"+MSG,Toast.LENGTH_SHORT).show();
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()){
            case R.id.mi01:
                Intent myInt1=new Intent(FourthActivity.this,SecActivity.class);
                startActivity(myInt1);
                break;
            case R.id.mi02:
                Intent myInt2=new Intent(FourthActivity.this,ThirdActivity.class);
                startActivity(myInt2);
                break;
            case R.id.mi03:
                Intent myInt3=new Intent(FourthActivity.this,FourthActivity.class);
