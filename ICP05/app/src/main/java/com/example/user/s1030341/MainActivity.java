...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn01.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                month=Integer.parseInt(et01.getText().toString());
                day=Integer.parseInt(et02.getText().toString());
                if((month>12)||(month<1)) {
                    ...
                    bdl.putString("Month", et01.getText().toString());
                    bdl.putString("Date", et02.getText().toString());
                    myInt.putExtras(bdl);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode){
            case 12:
                if(resultCode==1)
                    tv01.setText("生日:"+et01.getText().toString()+"月"+et02.getText().toString()+"日");
